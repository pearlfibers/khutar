...
$container_class = apply_filters( 'khutar_container_class_filter', 'container', 'single-post' );
...
?>
	<div class="<?php echo esc_attr( $container_class ); ?> single-post-container">
		<div class="row">
			<?php do_action( 'khutar_do_sidebar', 'single-post', 'left' ); ?>
			<article id="post-<?php echo esc_attr( get_the_ID() ); ?>"
				 ...
				 * @since 2.3.8
				 */
				do_action( 'khutar_before_post_content' );
				 ...
				 * @since 2.3.8
				 */
				do_action( 'khutar_after_post_content' );
				?>
			</article>
			<?php do_action( 'khutar_do_sidebar', 'single-post', 'right' ); ?>
		</div>
	</div>
<?php
get_footer();

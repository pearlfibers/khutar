...
const Card = ({ slug, data, setPluginState }) => {
	...
	const stringMap = {
		install: {
			static: __('Install', 'khutar'),
			progress: __('Installing', 'khutar'),
		},
		activate: {
			static: __('Activate', 'khutar'),
			progress: __('Activating', 'khutar'),
		},
		deactivate: {
			static: __('Deactivate', 'khutar'),
			progress: __('Deactivating', 'khutar'),
		},
	};
...
export default withDispatch((dispatch) => {
	const { setPluginState } = dispatch('khutar-dashboard');
	return {

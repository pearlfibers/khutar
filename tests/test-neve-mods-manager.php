...
/**
 * Class TestkhutarModsManager
 */
class TestkhutarModsManager extends WP_UnitTestCase {
	...
	public function test_default_value() {
		$mod_value = \khutar\Core\Settings\Mods::get( 'test_mod', 0 );
		$this->assertEquals( $mod_value, 0 );
		\khutar\Core\Settings\Mods::set( 'test_mod', 2 );
		$this->assertEquals( \khutar\Core\Settings\Mods::get( 'test_mod', 0 ), 2 );
	}
	...
	public function test_subkey_mod_value() {
		...
		$mod_value = \khutar\Core\Settings\Mods::get( 'test_mod2' );
		$this->assertEquals( $mod_value, [ 'subkey' => 1 ] );
		$mod_value = \khutar\Core\Settings\Mods::get( 'test_mod2.subkey' );
	...
	public function test_subkey_mod_value_decoded() {
		...
		$mod_value = \khutar\Core\Settings\Mods::get( $key );
		$this->assertEquals( $mod_value, $value );

		$mod_value = \khutar\Core\Settings\Mods::get( 'test_mod3.subkey' );
	...
	public function test_key_with_forced_default() {
		$mod_value = \khutar\Core\Settings\Mods::get( \khutar\Core\Settings\Config::MODS_BUTTON_PRIMARY_STYLE );
		$this->assertEquals( $mod_value['type'], 'fill' );
		$mod_value = \khutar\Core\Settings\Mods::get( \khutar\Core\Settings\Config::MODS_BUTTON_PRIMARY_STYLE . '.type' );
	...
	public function test_to_json_value() {
		...
		$mod_value = \khutar\Core\Settings\Mods::to_json( 'test_mod4' );

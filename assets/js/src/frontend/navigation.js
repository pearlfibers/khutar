...
function handleSearch() {
	...
	khutarEach(navSearch, (item) => {
		item.addEventListener('click', (e) => {
			e.stopPropagation();
		});
	});
	// Mobile search close buttons.
	khutarEach(close, (button) => {
		button.addEventListener('click', (e) => {
			e.preventDefault();
			khutarEach(navItem, (search) => {

/* global khutarCustomizePreview, _,jQuery */
...
window.addEventListener('load', function () {
	...
	_.each(khutarCustomizePreview, function (settings, settingType) {
			...
			wp.customize(settingId, function (setting) {
				setting.bind(function (newValue) {
                  ...
                  ${i.prop}: ${newValue} !important;
							...
							break;
						case 'khutar_background_control':
							...
							if (
								...
								khutarCustomizePreview.currentFeaturedImage
							) {
								newValue.imageUrl =
									khutarCustomizePreview.currentFeaturedImage;
							}
							...
							addCss(settingId, style);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Responsive_Radio_Buttons':
							handleResponsiveRadioButtons(args, newValue);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Radio_Buttons':
							if (!args.additional) return false;
							...
							break;
						case '\\khutar\\Customizer\\Controls\\Radio_Image':
							break;
						case '\\khutar\\Customizer\\Controls\\Range':
						case '\\khutar\\Customizer\\Controls\\React\\Responsive_Range':
							const value = JSON.parse(newValue);
							if (value.mobile > 0) {
								style +=
							...
							addCss(settingId, style);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Spacing':
							...
							addCss(settingId, style);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Typography':
							...
							addCss(settingId, style);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Button_Appearance':
                ...
                `;
                  ...
                  `;
						...
						case 'text':
							...
							break;
						case 'khutar_range_control':
						case 'khutar\\Customizer\\Controls\\React\\Range':
							...
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Color':
							const colorValue =
							...
							addCss(settingId, style);
							break;
						case '\\khutar\\Customizer\\Controls\\React\\Font_Family':
							break;
						case 'khutar\\Customizer\\Controls\\React\\Global_Colors':
	...
	wp.customize.preview.bind('font-selection', function (data) {
		let selector = khutarCustomizePreview[data.type][data.controlId].selector;
			...
			_.each(this.ranges, function (args, id) {
				wp.customize(id, function (value) {
					value.bind(function (newval) {
						...
						$.khutarCustomizeUtilities.setLiveCss(settings, values);
					});
				});
			});
		},
...
jQuery.khutarRangesPreview.init();
	...
	$.khutarLayoutPreview = {
		...
		contentWidths: {
			khutar_sitewide_content_width: {
				content: '.khutar-main > .container .col',
			...
			khutar_other_pages_content_width: {
				content:
					'body:not(.single):not(.archive):not(.blog):not(.search) .khutar-main > .container .col',
				sidebar:
		...
		containersLayoutMap: {
			khutar_default_container_style:
			...
			khutar_shop_archive_container_style:
				'.woocommerce-page.post-type-archive .khutar-main > div',
			khutar_single_product_container_style:
				'.single-product .khutar-main > div',
		},

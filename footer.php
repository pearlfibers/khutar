 ...
 * @since 1.0.4
 */
do_action( 'khutar_before_primary_end' ); ?>
 ...
 * @since 1.0.4
 */
do_action( 'khutar_after_primary' );
 ...
 */
if ( apply_filters( 'khutar_filter_toggle_content_parts', true, 'footer' ) === true ) {
 ...
 * @since 2.11
 */
do_action( 'khutar_body_end_before' );

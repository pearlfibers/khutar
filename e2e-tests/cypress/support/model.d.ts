...
declare namespace Cypress {
	...
	interface Chainable {
		 ...
		 * @param slug
		 * @example
		 *  cy.getCustomizerControl('khutar_global')
		 */
		 ...
		 * @param checkboxText
		 * @example
		 *	cy.activateCheckbox('#khutar', 'check text')
		 */
		activateCheckbox(checkboxSelector: string, checkboxText: string): void;

		/**
		 * Opens sidebar on khutar Options
		 *
		 * @example
		 *  cy.openkhutarSidebar()
		 */
		openkhutarSidebar(): Chainable<unknown>;

...
Cypress.Commands.add('insertCoverBlock', () => {
	const text =
		'<!-- wp:cover {"overlayColor":"khutar-button-color","align":"full"} -->\n' +
		'<div class="wp-block-cover alignfull has-khutar-button-color-background-color has-background-dim"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->\n' +
		'<p class="has-text-align-center has-large-font-size">test</p>\n' +
		'<!-- /wp:paragraph --></div></div>\n' +
		'<!-- /wp:cover -->\n' +
		'\n' +
		'<!-- wp:cover {"overlayColor":"khutar-button-color","align":"wide"} -->\n' +
		'<div class="wp-block-cover alignwide has-khutar-button-color-background-color has-background-dim"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->\n' +
		'<p class="has-text-align-center has-large-font-size">test</p>\n' +
		'<!-- /wp:paragraph --></div></div>\n' +
		'<!-- /wp:cover -->\n' +
		'\n' +
		'<!-- wp:cover {"overlayColor":"khutar-button-color"} -->\n' +
		'<div class="wp-block-cover has-khutar-button-color-background-color has-background-dim"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->\n' +
		'<p class="has-text-align-center has-large-font-size">test</p>\n' +
		'<!-- /wp:paragraph --></div></div>\n' +
		'<!-- /wp:cover -->';
...
Cypress.Commands.add('openkhutarSidebar', () => {
	cy.get('button.components-button[aria-label="khutar Options"]').click();
});

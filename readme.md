# khutar #
**Contributors:** [pearlfibers](https://profiles.wordpress.org/pearlfibers)  
...
khutar is a super fast, easily customizable, multi-purpose theme. Perfect for blogs, small business, startups, agencies, firms & e-commerce shops.

## Description ##
khutar is a super fast, easily customizable, multi-purpose theme. It’s perfect for blogs, small business, startups, agencies, firms, e-commerce shops (WooCommerce storefront) as well as personal portfolio sites and most types of projects. A fully AMP optimized and responsive theme, khutar will load in mere seconds and adapt perfectly on any viewing device. While it is lightweight and has a minimalist design, the theme is highly extendable, it has a highly SEO optimized code, resulting in top rankings in Google search results. khutar works perfectly with Gutenberg and the most popular page builders (Elementor, Brizy, Beaver Builder, Visual Composer, SiteOrigin, Divi). khutar is also WooCommerce ready, responsive, RTL & translation ready. Look no further. khutar is the perfect theme for you!

## Copyright ##
khutar WordPress theme, Copyright 2018 pearlfibers
khutar is distributed under the terms of the GNU GPLv2 or later

## Changelog ##

##### [Version 2.11.6](https://github.com/pearlfibers/khutar/compare/v2.11.5...v2.11.6) (2021-06-01)
...
##### [Version 2.11.5](https://github.com/pearlfibers/khutar/compare/v2.11.4...v2.11.5) (2021-05-31)
...
##### [Version 2.11.4](https://github.com/pearlfibers/khutar/compare/v2.11.3...v2.11.4) (2021-05-14)
...
##### [Version 2.11.3](https://github.com/pearlfibers/khutar/compare/v2.11.2...v2.11.3) (2021-05-12)
...
##### [Version 2.11.2](https://github.com/pearlfibers/khutar/compare/v2.11.1...v2.11.2) (2021-04-28)

- [Fix] Dropdowns (input select) in specific widgets do not respect global form styles  - https://github.com/pearlfibers/khutar/issues/2581
- [Fix] Wrong text color inheritance in group blocks with color settings - https://github.com/pearlfibers/khutar/issues/2540
- [Fix] Cart icon opening behavior when positioned on the left side of header - https://github.com/pearlfibers/khutar/issues/2468
- [Fix] Improve accessibility for external links in the khutar page and customizer
- [Fix] Color Picker Modal remains open even after switching Color Palettes - https://github.com/pearlfibers/khutar/issues/2628
- [Fix] Increase Templates Cloud visibility on khutar options page
- [Fix] Infinite scroll loads posts of incorrect language - https://github.com/pearlfibers/khutar/issues/2696
- [Feat] Add global color as presets in beaver builder - https://github.com/pearlfibers/khutar/issues/2328.
- [Feat] Ignore lazyload on above the fold images
- [Feat] implement next page links for infinite scroll
- [Feat] Adds compatibility for meta association on template import/export for khutar Cloud




##### [Version 2.11.1](https://github.com/pearlfibers/khutar/compare/v2.11.0...v2.11.1) (2021-04-13)
...
#### [Version 2.11.0](https://github.com/pearlfibers/khutar/compare/v2.10.4...v2.11.0) (2021-04-12)
...
##### [Version 2.10.4](https://github.com/pearlfibers/khutar/compare/v2.10.3...v2.10.4) (2021-03-16)
...
##### [Version 2.10.3](https://github.com/pearlfibers/khutar/compare/v2.10.2...v2.10.3) (2021-03-16)
...
##### [Version 2.10.2](https://github.com/pearlfibers/khutar/compare/v2.10.1...v2.10.2) (2021-03-01)
...
- [Fix] changelog parsing in the khutar Options dashboard page
...
##### [Version 2.10.1](https://github.com/pearlfibers/khutar/compare/v2.10.0...v2.10.1) (2021-02-10)
...
#### [Version 2.10.0](https://github.com/pearlfibers/khutar/compare/v2.9.5...v2.10.0) (2021-01-18)
...
##### [Version 2.9.5](https://github.com/pearlfibers/khutar/compare/v2.9.4...v2.9.5) (2020-12-28)
...
##### [Version 2.9.4](https://github.com/pearlfibers/khutar/compare/v2.9.3...v2.9.4) (2020-12-25)
...
##### [Version 2.9.3](https://github.com/pearlfibers/khutar/compare/v2.9.2...v2.9.3) (2020-12-17)
...
##### [Version 2.9.2](https://github.com/pearlfibers/khutar/compare/v2.9.1...v2.9.2) (2020-12-15)
...
##### [Version 2.9.1](https://github.com/pearlfibers/khutar/compare/v2.9.0...v2.9.1) (2020-12-07)
...
#### [Version 2.9.0](https://github.com/pearlfibers/khutar/compare/v2.8.4...v2.9.0) (2020-11-24)
...
##### [Version 2.8.4](https://github.com/pearlfibers/khutar/compare/v2.8.3...v2.8.4) (2020-11-02)
...
##### [Version 2.8.3](https://github.com/pearlfibers/khutar/compare/v2.8.2...v2.8.3) (2020-10-19)
...
##### [Version 2.8.2](https://github.com/pearlfibers/khutar/compare/v2.8.1...v2.8.2) (2020-10-01)

- [Feat] New Blog Layout options
- [Feat] New Header Builder presets
- [Feat] Support for Alpha RGBa Color Picker
- [Feat] Enhancements to the khutar Options page
...
##### [Version 2.8.1](https://github.com/pearlfibers/khutar/compare/v2.8.0...v2.8.1) (2020-09-17)
...
#### [Version 2.8.0](https://github.com/pearlfibers/khutar/compare/v2.7.7...v2.8.0) (2020-09-03)
...
##### [Version 2.7.7](https://github.com/pearlfibers/khutar/compare/v2.7.6...v2.7.7) (2020-08-19)
...
##### [Version 2.7.6](https://github.com/pearlfibers/khutar/compare/v2.7.5...v2.7.6) (2020-08-04)
...
##### [Version 2.7.5](https://github.com/pearlfibers/khutar/compare/v2.7.4...v2.7.5) (2020-07-10)
...
##### [Version 2.7.4](https://github.com/pearlfibers/khutar/compare/v2.7.3...v2.7.4) (2020-07-08)
...
##### [Version 2.7.3](https://github.com/pearlfibers/khutar/compare/v2.7.2...v2.7.3) (2020-06-23)
...
- [Fix] khutar Options page in RTL mode
...
##### [Version 2.7.2](https://github.com/pearlfibers/khutar/compare/v2.7.1...v2.7.2) (2020-06-04)
...
- [Feat] New khutar_before_header_wrapper_hook and khutar_after_header_wrapper_hook hooks
- [Fix] Dismissable notice for contributing to khutar
...
- [Fix] khutar Options page not loading in Microsoft Edge v18
- [Fix] Update list of Google Fonts
...
##### [Version 2.7.1](https://github.com/pearlfibers/khutar/compare/v2.7.0...v2.7.1) (2020-05-21)
...
- [Fix] khutar Options page on lower resolutions
- [Fix] Check for the Rest API endpoint before allowing users to start an import




#### [Version 2.7.0](https://github.com/pearlfibers/khutar/compare/v2.6.6...v2.7.0) (2020-05-13)

- [Feat] Improved khutar Options page and onboarding experience
...
- New starter sites
- Book Shop - https://pearlfibers.com/demo/?theme=Book%20Shop
- Psychologist - https://pearlfibers.com/demo/?theme=Psychologist
- Doctors - https://pearlfibers.com/demo/?theme=Doctors%202
- Pet Shop - https://pearlfibers.com/demo/?theme=Pet%20Shop
- Apparel - https://pearlfibers.com/demo/?theme=Apparel
- Boat Rental - https://pearlfibers.com/demo/?theme=Boat%20Rental
- Jewellery Shop - https://pearlfibers.com/demo/?theme=Jewellery%20Shop%202
- Perfume Shop - https://pearlfibers.com/demo/?theme=Perfume%20Shop
- Music Band - https://pearlfibers.com/demo/?theme=Music%20Band%202
- Fitness Trainer - https://pearlfibers.com/demo/?theme=Fitness%20Trainer




##### [Version 2.6.6](https://github.com/pearlfibers/khutar/compare/v2.6.5...v2.6.6) (2020-04-07)
...
##### [Version 2.6.5](https://github.com/pearlfibers/khutar/compare/v2.6.4...v2.6.5) (2020-04-06)
...
##### [Version 2.6.4](https://github.com/pearlfibers/khutar/compare/v2.6.3...v2.6.4) (2020-03-23)
...
##### [Version 2.6.3](https://github.com/pearlfibers/khutar/compare/v2.6.2...v2.6.3) (2020-03-19)
...
* New Starter Sites
* Web Agency - https://pearlfibers.com/demo/?theme=Web%20Agency
* Blogger -  https://pearlfibers.com/demo/?theme=Blogger
...
* [Fix] Removed khutar Visual Integration causing issues in the editor
...
* New Starter Sites
* Tattoo - https://pearlfibers.com/demo/?theme=Tattoo
* Life Coach - https://pearlfibers.com/demo/?theme=Life%20Coach
* Creative Portfolio - https://pearlfibers.com/demo/?theme=Creative%20Portfolio
* Redesigned Starter Sites
* Energy Panels - https://pearlfibers.com/demo/?theme=Energy%20Panels
* Lawyers - https://pearlfibers.com/demo/?theme=Lawyers
* Freelancer - https://pearlfibers.com/demo/?theme=Freelancer
* New Beaver Builder Starter Sites
...
* [Fix] Removed khutar's custom integration with Gutenberg by default
...
* Fixed compatibility with khutar's custom Mega Menu integration
...
* Fixed lists styling in the comments area
* Compatibility for khutar Pro's Typekit module
...
* Replaced khutar icons with SVGs for a better loading time
...
* Compatibility with the khutar Hooks plugin
* WPML compatibility
...
* Refactor the code to allow child themes to override the views folder - https://docs.pearlfibers.com/article/985-how-to-create-a-child-theme-for-khutar
...
* Improved the khutar Energy Panel starter site


### 1.1.0 - 2019-01-31  ###

* NEW khutar Specific Gutenberg blocks for Otter Blocks
* NEW Posts navigation control
* Display category description of categories archive pages
* Fixed issue with the khutar Restaurant starter site not importing in some cases
...
* Optimized images used in the khutar starter site
* Fixed compatibility with the Lazy Load plugin duplicating images


### 1.0.26 - 2018-12-17  ###

* Fixed issues in IE with the khutar 2018 Site
* Fixed issues in AMP with the navigation menu


### 1.0.25 - 2018-12-14  ###

* Optimized images for khutar demo and fixed issue with IE
...
* Fixed menu anchors in the khutar demos
...
* Improved khutar Options page layout
* New khutar Lawyers demo
* New khutar Doctors demo
...
### 1.0.7 ###
* Accessibility ready
* Refactored the About khutar page
* Design improvements
...
* Demo data for khutar 2018 template
...
## Resources ##
* khutar Icons based on Font Awesome Icons licensed under CC BY 4.0 License (https://creativecommons.org/licenses/by/4.0/).
...
* khutar-patterns-1.jpg - https://pxhere.com/el/photo/1434027
* khutar-patterns-2.jpg - https://pxhere.com/el/photo/1458707
* khutar-patterns-3.jpg - https://pxhere.com/el/photo/764654
* khutar-patterns-4.jpg - https://pxhere.com/el/photo/762278
* khutar-patterns-6.jpg - https://pxhere.com/el/photo/1433753
* khutar-patterns-8.jpg - https://pxhere.com/el/photo/1594712
* khutar-patterns-10.jpg - https://pxhere.com/el/photo/1431575
* khutar-patterns-11.jpg - https://pxhere.com/el/photo/1451429
* khutar-patterns-12.jpg - https://pxhere.com/el/photo/1229843
* khutar-patterns-15.jpg - https://pxhere.com/el/photo/1432963
* khutar-patterns-16.jpg - https://pxhere.com/el/photo/1575315
* khutar-patterns-17.jpg - https://pxhere.com/el/photo/706582
* khutar-patterns-18.jpg - https://pxhere.com/el/photo/1391834
* khutar-patterns-19.jpg - https://pxhere.com/el/photo/1555639
* khutar-patterns-20.jpg - https://pxhere.com/el/photo/1561935
* khutar-patterns-21.jpg - https://pxhere.com/el/photo/1567113
* khutar-patterns-22.jpg - https://pxhere.com/el/photo/1545615

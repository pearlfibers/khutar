...
/**
 * The class responsible for instantiating new khutar features.
 *
 * @package    khutar\Core
...
class Factory {
	 ...
	 */
	public function __construct( $modules, $namespace = '\\khutar\\' ) {
	...
	/**
	 * The build method for creating a new khutar module class.
	 *
	 * @since   1.0.0
	 * @access  public
	 *

 ...
 *
 * @package khutar\Core\Settings
 */

namespace khutar\Core\Settings;
...
class Config {
	 ...
	 * @deprecated
	 */
	const MODS_LINK_COLOR = 'khutar_link_color';
	/**
	 * Link hover color - deprecated.
	 *
	 * @deprecated
	 */
	const MODS_LINK_HOVER_COLOR           = 'khutar_link_hover_color';
	const MODS_GLOBAL_COLORS              = 'khutar_global_colors';
	const MODS_TEXT_COLOR                 = 'khutar_text_color';
	const MODS_CONTAINER_WIDTH            = 'khutar_container_width';
	const MODS_SITEWIDE_CONTENT_WIDTH     = 'khutar_sitewide_content_width';
	const MODS_OTHERS_CONTENT_WIDTH       = 'khutar_other_pages_content_width';
	const MODS_ARCHIVE_CONTENT_WIDTH      = 'khutar_blog_archive_content_width';
	const MODS_SINGLE_CONTENT_WIDTH       = 'khutar_single_post_content_width';
	const MODS_SHOP_ARCHIVE_CONTENT_WIDTH = 'khutar_shop_archive_content_width';
	const MODS_SHOP_SINGLE_CONTENT_WIDTH  = 'khutar_single_product_content_width';
	const MODS_ADVANCED_LAYOUT_OPTIONS    = 'khutar_advanced_layout_options';
	const MODS_BUTTON_PRIMARY_STYLE       = 'khutar_button_appearance';
	const MODS_BUTTON_SECONDARY_STYLE     = 'khutar_secondary_button_appearance';
	const MODS_BUTTON_PRIMARY_PADDING     = 'khutar_button_padding';
	/**
	...
	const MODS_BUTTON_SECONDARY_PADDING    = 'khutar_secondary_button_padding';
	const MODS_TYPEFACE_GENERAL            = 'khutar_typeface_general';
	const MODS_TYPEFACE_H1                 = 'khutar_h1_typeface_general';
	const MODS_TYPEFACE_H2                 = 'khutar_h2_typeface_general';
	const MODS_TYPEFACE_H3                 = 'khutar_h3_typeface_general';
	const MODS_TYPEFACE_H4                 = 'khutar_h4_typeface_general';
	const MODS_TYPEFACE_H5                 = 'khutar_h5_typeface_general';
	const MODS_TYPEFACE_H6                 = 'khutar_h6_typeface_general';
	const MODS_FONT_GENERAL                = 'khutar_body_font_family';
	const MODS_FONT_HEADINGS               = 'khutar_headings_font_family';
	const MODS_DEFAULT_CONTAINER_STYLE     = 'khutar_default_container_style';
	const MODS_SINGLE_POST_CONTAINER_STYLE = 'khutar_single_post_container_style';

	const MODS_BUTTON_TYPEFACE           = 'khutar_button_typeface';
	const MODS_SECONDARY_BUTTON_TYPEFACE = 'khutar_secondary_button_typeface';

	const MODS_TYPEFACE_ARCHIVE_POST_TITLE   = 'khutar_archive_typography_post_title';
	const MODS_TYPEFACE_ARCHIVE_POST_EXCERPT = 'khutar_archive_typography_post_excerpt';
	const MODS_TYPEFACE_ARCHIVE_POST_META    = 'khutar_archive_typography_post_meta';

	const MODS_TYPEFACE_SINGLE_POST_TITLE         = 'khutar_single_post_typography_post_title';
	const MODS_TYPEFACE_SINGLE_POST_META          = 'khutar_single_post_typography_post_meta';
	const MODS_TYPEFACE_SINGLE_POST_COMMENT_TITLE = 'khutar_single_post_typography_comments_title';

	const MODS_FORM_FIELDS_PADDING          = 'khutar_form_fields_padding';
	const MODS_FORM_FIELDS_SPACING          = 'khutar_form_fields_spacing';
	const MODS_FORM_FIELDS_BACKGROUND_COLOR = 'khutar_form_fields_background_color';
	const MODS_FORM_FIELDS_BORDER_WIDTH     = 'khutar_form_fields_border_width';
	const MODS_FORM_FIELDS_BORDER_RADIUS    = 'khutar_form_fields_border_radius';
	const MODS_FORM_FIELDS_BORDER_COLOR     = 'khutar_form_fields_border_color';
	const MODS_FORM_FIELDS_LABELS_SPACING   = 'khutar_label_spacing';
	const MODS_FORM_FIELDS_TYPEFACE         = 'khutar_input_typeface';
	const MODS_FORM_FIELDS_COLOR            = 'khutar_input_text_color';
	const MODS_FORM_FIELDS_LABELS_TYPEFACE  = 'khutar_label_typeface';

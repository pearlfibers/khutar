	...
	private static function defaults( $key ) {
		switch ( $key ) {
			...
			case Config::MODS_BUTTON_PRIMARY_STYLE:
				return khutar_get_button_appearance_default();
			case Config::MODS_BUTTON_SECONDARY_STYLE:
				return khutar_get_button_appearance_default( 'secondary_button' );
			case Config::MODS_TYPEFACE_GENERAL:
				$defaults  = self::get_typography_defaults(
					[
						'line_height'    => 'khutar_body_line_height',
						'letter_spacing' => 'khutar_body_letter_spacing',
						'font_weight'    => 'khutar_body_font_weight',
						'text_transform' => 'khutar_body_text_transform',
					]
				);
				$font_size = self::to_json( 'khutar_body_font_size' );
				if ( ! empty( $font_size ) ) {
			...
			case Config::MODS_TYPEFACE_H6:
				$defaults   = self::get_typography_defaults(
					[
						'line_height'    => 'khutar_headings_line_height',
						'letter_spacing' => 'khutar_headings_letter_spacing',
						'font_weight'    => 'khutar_headings_font_weight',
						'text_transform' => 'khutar_headings_text_transform',
					]
				);
				$legacy_map = [
					Config::MODS_TYPEFACE_H6 => [
						'font_size'   => 'khutar_h6_font_size',
						'line_height' => 'khutar_h6_line_height',
					],
					Config::MODS_TYPEFACE_H5 => [
						'font_size'   => 'khutar_h5_font_size',
						'line_height' => 'khutar_h5_line_height',
					],
					Config::MODS_TYPEFACE_H4 => [
						'font_size'   => 'khutar_h4_font_size',
						'line_height' => 'khutar_h4_line_height',
					],
					Config::MODS_TYPEFACE_H3 => [
						'font_size'   => 'khutar_h3_font_size',
						'line_height' => 'khutar_h3_line_height',
					],
					Config::MODS_TYPEFACE_H2 => [
						'font_size'   => 'khutar_h2_font_size',
						'line_height' => 'khutar_h2_line_height',
					],
					Config::MODS_TYPEFACE_H1 => [
						'font_size'   => 'khutar_h1_font_size',
						'line_height' => 'khutar_h1_line_height',
					],
				];

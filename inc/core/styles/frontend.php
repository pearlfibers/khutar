...
class Frontend extends Generator {
	...
	public function setup_blog_colors() {
		$this->_subscribers['.cover-post .inner, .cover-post .inner a:not(.button), .cover-post .inner a:not(.button):hover, .cover-post .inner a:not(.button):focus, .cover-post .inner li'] = [
			Config::CSS_PROP_COLOR => [
				Dynamic_Selector::META_KEY => 'khutar_blog_covers_text_color',
			],
		];

		$selector = get_theme_mod( 'khutar_blog_archive_layout', 'grid' ) === 'covers' ? '.cover-post.nv-post-thumbnail-wrap' : '.nv-post-thumbnail-wrap img';

		$this->_subscribers[ $selector ] = [
			Config::CSS_PROP_BOX_SHADOW => [
				Dynamic_Selector::META_KEY    => 'khutar_post_thumbnail_box_shadow',
	...
	public function setup_typography() {
		...
		foreach ( khutar_get_headings_selectors() as $id => $heading_selector
		) {
			$heading_mod                             = sprintf( 'khutar_%s_typeface_general', $id );
		...
		// Legacy filters.
		$extra_selectors_heading = apply_filters( 'khutar_headings_font_family_selectors', '' );
		...
		$extra_selectors_body = apply_filters( 'khutar_body_font_family_selectors', '' );
	...
	public function setup_layout_subscribers() {
		...
		$this->_subscribers['body:not(.single):not(.archive):not(.blog):not(.search) .khutar-main > .container .col'] = [
			Config::CSS_PROP_MAX_WIDTH => [
		...
		$this->_subscribers['.khutar-main > .archive-container .nv-index-posts.col'] = [
			Config::CSS_PROP_MAX_WIDTH => [
		...
		$this->_subscribers['.khutar-main > .archive-container .nv-sidebar-wrap']    = [
			Config::CSS_PROP_MAX_WIDTH => [
				Dynamic_Selector::META_KEY         => Config::MODS_ARCHIVE_CONTENT_WIDTH,
				Dynamic_Selector::META_DEVICE_ONLY => Dynamic_Selector::DESKTOP,
				Dynamic_Selector::META_FILTER      => 'minus_100',
		...
		$this->_subscribers['.khutar-main > .single-post-container .nv-single-post-wrap.col'] = [
			Config::CSS_PROP_MAX_WIDTH => [
		...
		$this->_subscribers['.khutar-main > .single-post-container .nv-sidebar-wrap'] = [
			Config::CSS_PROP_MAX_WIDTH => [
				Dynamic_Selector::META_KEY         => Config::MODS_SINGLE_CONTENT_WIDTH,
				Dynamic_Selector::META_DEVICE_ONLY => Dynamic_Selector::DESKTOP,
				Dynamic_Selector::META_FILTER      => 'minus_100',
		...
		$this->_subscribers['.archive.woocommerce .khutar-main > .shop-container .nv-shop.col']     = [
			Config::CSS_PROP_MAX_WIDTH => [
		...
		$this->_subscribers['.archive.woocommerce .khutar-main > .shop-container .nv-sidebar-wrap'] = [
			Config::CSS_PROP_MAX_WIDTH => [
				Dynamic_Selector::META_KEY         => Config::MODS_SHOP_ARCHIVE_CONTENT_WIDTH,
				Dynamic_Selector::META_DEVICE_ONLY => Dynamic_Selector::DESKTOP,
				Dynamic_Selector::META_FILTER      => 'minus_100',
		...
		$this->_subscribers['.single-product .khutar-main > .shop-container .nv-shop.col'] = [
			Config::CSS_PROP_MAX_WIDTH => [
		...
		$this->_subscribers['.single-product .khutar-main > .shop-container .nv-sidebar-wrap'] = [
			Config::CSS_PROP_MAX_WIDTH => [
				Dynamic_Selector::META_KEY         => Config::MODS_SHOP_SINGLE_CONTENT_WIDTH,
				Dynamic_Selector::META_DEVICE_ONLY => Dynamic_Selector::DESKTOP,
				Dynamic_Selector::META_FILTER      => 'minus_100',

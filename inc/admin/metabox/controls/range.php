...
class Range extends Control_Base {
	...
	public function render_content( $post_id ) {
		...
		if ( isset( $this->settings['depends_on'] ) ) {
			...
			$class      .= ' khutar-dependent';
		}

		$markup = '
<style>
.khutar-range-input{display: flex; align-items: center;}
.khutar-range-input .nv-range{flex-grow: 1; margin-right: 5px;}
.khutar-range-input .nv-number{min-width: 0; margin-left: auto;}
.khutar-range-input.khutar-hidden{display: none;}
</style>';

...
const SortableList = sortableContainer(
	({children}) => {
		return <div className="khutar-meta-control khutar-meta-sortable-items">{children}</div>;
	}
);
	...
	render() {
		...
		return (
			<div>
				...
				<div className="disabled-items khutar-meta-control">
				{

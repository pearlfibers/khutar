...
return [
	'post_type'    => 'page',
	'post_title'   => _x( 'Portofolio', 'Theme starter content', 'khutar' ),
...
<h1 class="has-text-align-left has-khutar-text-color-color has-text-color">Portfolio</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<!-- wp:heading {"textAlign":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Buzz Website</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color"} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"textAlign":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Branding for Chatoue</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">IMB Internal Website</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Social App</h3>
<!-- /wp:heading -->

...
return [
	'post_type'    => 'page',
	'post_title'   => _x( 'Home', 'Theme starter content', 'khutar' ),
...
<!-- wp:heading {"level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Fixed Price Projects</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Receive on time</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Fast work turnaround</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"left","textColor":"khutar-text-color"} -->
<h2 class="has-text-align-left has-khutar-text-color-color has-text-color">Web Design</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","textColor":"khutar-text-color","style":{"typography":{"fontSize":17}}} -->
<p class="has-text-align-left has-khutar-text-color-color has-text-color" style="font-size:17px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
<!-- /wp:paragraph -->
...
<!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:heading {"textAlign":"left","textColor":"khutar-text-color"} -->
<h2 class="has-text-align-left has-khutar-text-color-color has-text-color">Branding</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"textColor":"khutar-text-color"} -->
<h2 class="has-khutar-text-color-color has-text-color">Featured Work</h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"align":"left","textColor":"khutar-text-color","fontSize":"normal"} -->
<p class="has-text-align-left has-khutar-text-color-color has-text-color has-normal-font-size">“What is the point of being alive if you don’t at least try to do something remarkable?”</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">JANET MORRIS</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">WILLIE BROWN</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">SEAN FISHER</p>
<!-- /wp:paragraph -->

...
return [
	'post_type'    => 'page',
	'post_title'   => _x( 'About', 'Theme starter content', 'khutar' ),
...
<div class="wp-block-group"><div class="wp-block-group__inner-container"><!-- wp:heading {"level":1,"className":"has-text-align-left","textColor":"khutar-text-color"} -->
<h1 class="has-text-align-left has-khutar-text-color-color has-text-color">About Us</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:heading {"textColor":"khutar-text-color"} -->
<h2 class="has-khutar-text-color-color has-text-color">Our Story</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"khutar-text-color","fontSize":"medium"} -->
<p class="has-khutar-text-color-color has-text-color has-medium-font-size">Are there any leftovers in the kitchen? what are the expectations but technologically savvy.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">Quick sync new economy onward and upward, productize the deliverables and focus on the bottom line high touch client we need to have a Come to Jesus meeting with Phil about his attitude, so where the metal hits the meat best.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:heading {"align":"left","level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-left has-text-align-center has-khutar-text-color-color has-text-color">Super Efficient</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","textColor":"khutar-text-color","style":{"typography":{"fontSize":15}}} -->
<p class="has-text-align-left has-khutar-text-color-color has-text-color" style="font-size:15px">Lorem ipsum dolor sit amet elit do, consectetur adipiscing, sed eiusmod tempor.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"align":"left","level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-left has-text-align-center has-khutar-text-color-color has-text-color">Deeply Committed</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"align":"left","level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-left has-text-align-center has-khutar-text-color-color has-text-color">Highly Skilled</h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"align":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Keith Marshall</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color"} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color">Designer</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"align":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">George Williams</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color"} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color">Developer</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"align":"center","level":3,"textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Julia Castillo</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color"} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color">Client Service</p>
<!-- /wp:paragraph -->

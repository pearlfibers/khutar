...
return [
	'post_type'    => 'page',
	'post_title'   => _x( 'Project Details', 'Theme starter content', 'khutar' ),
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:70%"><!-- wp:heading {"level":1,"className":"has-text-align-left","textColor":"khutar-text-color"} -->
<h1 class="has-text-align-left has-khutar-text-color-color has-text-color">James Joyce</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"khutar-text-color","style":{"typography":{"fontSize":22}}} -->
<p class="has-khutar-text-color-color has-text-color" style="font-size:22px">How we helped James Joyce get a brand-consistent website that converts visitors into clients.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"34%"} -->
<div class="wp-block-column" style="flex-basis:34%"><!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">Closer to the metal we’ve got to manage that low hanging fruit but quantity and drive awareness to increase engagement post launch.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">Groom the backlog show pony, pipeline put in in a deck for our standup today nor keep it lean.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"textColor":"khutar-text-color"} -->
<p class="has-khutar-text-color-color has-text-color">“What is the point of being alive if you don’t at least try to do something remarkable?”</p>
<!-- /wp:paragraph -->
...
<h2 class="has-khutar-text-color-color has-text-color">Other projects</h2>
<!-- /wp:heading -->

...
return [
	'post_type'    => 'page',
	'post_name'    => 'contact',
	'post_title'   => _x( 'Contact', 'Theme starter content', 'khutar' ),
...
<h1 class="has-text-align-left has-khutar-text-color-color has-text-color">Get in touch</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Call us</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color","style":{"typography":{"fontSize":15}}} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color" style="font-size:15px">509-728-8632 | Monday - Friday</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Email</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color","style":{"typography":{"fontSize":15}}} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color" style="font-size:15px">info@example.com</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"has-text-align-center","textColor":"khutar-text-color"} -->
<h3 class="has-text-align-center has-khutar-text-color-color has-text-color">Offices</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"khutar-text-color","style":{"typography":{"fontSize":15}}} -->
<p class="has-text-align-center has-khutar-text-color-color has-text-color" style="font-size:15px">2982 Sun Valley Road, Pittsburgh</p>
<!-- /wp:paragraph -->

...
return array(
	'title'      => __( 'Light header with left-aligned content', 'khutar' ),
	'content'    => '<!-- wp:cover {"url":"' . trailingslashit( get_template_directory_uri() ) . 'assets/img/patterns/khutar-patterns-18.jpg","dimRatio":73,"overlayColor":"white","minHeight":500,"align":"full"} -->
<div class="wp-block-cover alignfull has-background-dim-70 has-white-background-color has-background-dim" style="background-image:url(' . trailingslashit( get_template_directory_uri() ) . 'assets/img/patterns/khutar-patterns-18.jpg);min-height:500px"><div class="wp-block-cover__inner-container"><!-- wp:columns {"align":"wide"} -->

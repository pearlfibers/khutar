 ...
 * @copyright  Copyright (c) 2017, pearlfibers
 * @link       http://pearlfibers.com/
 * @license    http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 */

namespace khutar\Customizer\Controls;
...
class Tabs extends \WP_Customize_Control {
	...
	public function content_template() {
		...
		<div class="khutar-tabs-control" id="">
		<# var i = 1;
			for( tab in data.tabs) { #>
				...
				#>
			<div class="khutar-customizer-tab <# if( i === 1 ){#> active <#}#>" data-tab="{{tab}}">

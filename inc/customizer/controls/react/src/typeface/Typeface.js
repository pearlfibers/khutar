...
const Typeface = (props) => {
	...
	const renderTextTransform = () => {
		...
		return (
			<InlineSelect
				label={__('Transform', 'khutar')}
				value={value.textTransform}
				options={[
					{ value: 'none', label: __('None', 'khutar') },
					{
						value: 'capitalize',
						label: __('Capitalize', 'khutar'),
					},
					{
						value: 'lowercase',
						label: __('Lowercase', 'khutar'),
					},
					{
						value: 'uppercase',
						label: __('Uppercase', 'khutar'),
					},
				]}
	...
	const renderLetterSpacing = () => {
		...
		return (
			<NumberControl
				...
				label={__('Letter Spacing', 'khutar')}
				step={0.1}

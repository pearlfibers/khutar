...
const NRSpacingComponent = ({ control }) => {
	...
	const options = [
		{ type: 'top', label: __('Top', 'khutar'), value: top },
		{ type: 'right', label: __('Right', 'khutar'), value: right },
		{ type: 'bottom', label: __('Bottom', 'khutar'), value: bottom },
		{ type: 'left', label: __('Left', 'khutar'), value: left },
	];
	...
	const wrapClasses = classnames([
		'khutar-white-background-control',
		'khutar-sizing',
	]);

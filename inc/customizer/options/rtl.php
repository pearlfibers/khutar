...
class Rtl extends Base_Customizer {
	...
	protected function change_controls() {
		...
		$this->change_customizer_object( 'control', 'khutar_navigation_layout', 'choices', $this->rtl_navigation_layout_choices() );

		$this->change_customizer_object( 'control', 'khutar_top_bar_layout', 'choices', $this->rtl_top_bar_layout_choices() );

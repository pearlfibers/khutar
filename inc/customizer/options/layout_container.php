...
class Layout_Container extends Base_Customizer {
	...
	private function section_container() {
		$this->add_section(
			new Section(
				...
				array(
					'priority' => 25,
					'title'    => esc_html__( 'Container', 'khutar' ),
					'panel'    => 'khutar_layout',
				)
			)
		);
	...
	private function control_container_width() {
		$this->add_control(
			new Control(
				...
				[
					'label'       => esc_html__( 'Container width', 'khutar' ),
					'section'     => 'khutar_container',
					'type'        => 'khutar_responsive_range_control',
					'input_attrs' => [
						'min'        => 200,
						'max'        => 2000,
						'units'      => [ 'px' ],
	...
	private function control_container_style() {
		$container_style_controls = array(
			'khutar_default_container_style'      => array(
				'priority' => 30,
				'label'    => __( 'Default Container Style', 'khutar' ),
			),
			'khutar_blog_archive_container_style' => array(
				'priority' => 35,
				'label'    => __( 'Blog / Archive Container Style', 'khutar' ),
			),
			'khutar_single_post_container_style'  => array(
				'priority' => 40,
				'label'    => __( 'Single Post Container Style', 'khutar' ),
			),
		);
		...
		if ( class_exists( 'WooCommerce', false ) ) {
			$container_style_controls = array_merge(
				...
				array(
					'khutar_shop_archive_container_style'   => array(
						'priority' => 45,
						'label'    => __( 'Shop / Archive Container Style', 'khutar' ),
					),
					'khutar_single_product_container_style' => array(
						'priority' => 50,
						'label'    => __( 'Single Product Container Style', 'khutar' ),
					),
				)
			);
		}

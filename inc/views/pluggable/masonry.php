...
class Masonry extends Base_View {
	...
	public function init() {
		...
		add_filter( 'khutar_filter_main_script_dependencies', array( $this, 'filter_dependencies' ) );
	}
	...
	public function is_masonry_enabled() {
		...
		return get_theme_mod( 'khutar_enable_masonry', false );
	}
	...
	private function get_max_columns() {
		$columns = get_theme_mod( 'khutar_grid_layout', '{mobile:1, tablet:1, desktop:1}' );
		if ( is_int( $columns ) ) {
			return $columns;
		}
		if ( empty( $columns ) ) {

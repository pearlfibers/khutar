 ...
 * @return string
 */
function khutar_sanitize_colors( $value ) {
	...
	if ( 'rgba' === $mode ) {
		return khutar_sanitize_rgba( $value );
	} else {
 ...
 * @return string
 */
function khutar_sanitize_rgba( $value ) {
	$red   = 'rgba(0,0,0,0)';
	$green = 'rgba(0,0,0,0)';
	$blue  = 'rgba(0,0,0,0)';
 ...
 * @return string
 */
function khutar_sanitize_checkbox( $value ) {
 ...
 * @since 1.1.38
 */
function khutar_is_json( $string ) {
 ...
 * @return float
 */
function khutar_sanitize_range_value( $input ) {
	if ( ! khutar_is_json( $input ) ) {
 ...
 * @return string
 */
function khutar_sanitize_font_weight( $value ) {
 ...
 * @return string
 */
function khutar_sanitize_text_transform( $value ) {
 ...
 */
function khutar_sanitize_background( $value ) {
	if ( ! is_array( $value ) ) {
		return new WP_Error();
	}
 ...
 * @return array
 */
function khutar_sanitize_button_appearance( $value ) {
	if ( is_array( $value ) ) {
		return $value;
	}
 ...
 * @return array
 */
function khutar_sanitize_typography_control( $value ) {
	$keys = [
		'lineHeight',
		'letterSpacing',
		'fontWeight',

 ...
 */
function khutar_hfg_migrate_skin_to_bg_color() {
	$flag = 'khutar_migrated_hfg_colors';
...
add_action( 'init', 'khutar_hfg_migrate_skin_to_bg_color' );
 ...
 */
function khutar_hfg_footer_settings() {
	$builder  = [
		'desktop' => [
			'top'    => [],
			'bottom' => [],
	...
	$sidebars = (int) get_theme_mod( 'khutar_footer_widget_columns', '0' );
	...
	$components   = [];
	$content_type = get_theme_mod( 'khutar_footer_content_type', 'text' );
 ...
 */
function khutar_hfg_header_settings() {
	$builder    = [
		'desktop' => [
			'top'    => [],
			'main'   => [],
	...
	$components = [];
	if ( (bool) get_theme_mod( 'khutar_top_bar_enable', false ) ) {
		$alignament = get_theme_mod( 'khutar_top_bar_layout', 'content-menu' );
	...
	$layout = get_theme_mod( 'khutar_navigation_layout', 'left' );
...
add_filter(
	'hfg_settings_schema',
	function ( $old_schema ) {
		$header     = khutar_hfg_header_settings();
		$footer     = khutar_hfg_footer_settings();
 ...
 * @return array
 */
function khutar_add_page_header_menu_classes( $args ) {
...
add_filter( 'wp_nav_menu_args', 'khutar_add_page_header_menu_classes', 10, 4 );

  ...
  CustomizeBuilderV1 = function(options, id) {
    let Builder = {
      ...
      listenForLayoutSideloading() {
        let that = this
        document.addEventListener( 'khutar-changed-builder-value', function(e) {
      ...
      init: function(controlId, items, devices) {
        ...
        that.container.on(
          ...
          function(e) {
            ...
            let event = new CustomEvent( 'khutarChangedRepsonsivePreview', {
              'detail': device
            } )
...
( function($, wpcustomize) {
  ...
  wpcustomize.bind( 'ready', function() {
    ...
    wpcustomize.previewer.bind( 'khutar-toggle-navbar', function() {

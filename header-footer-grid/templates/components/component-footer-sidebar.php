			...
			<div class="textwidget">
				...
				echo sprintf(
					...
					sprintf(
						...
						__( 'Replace this widget content by going to %s and add widgets into this widget area.', 'khutar' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						sprintf(
							...
							__( 'Appearance &rarr; Customize &rarr; Footer &rarr;', 'khutar' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped

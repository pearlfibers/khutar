...
$item_attributes = apply_filters( 'khutar_nav_toggle_data_attrs', '' );
...
<div class="menu-mobile-toggle item-button navbar-toggle-wrapper">
	<button class="navbar-toggle"
		...
		?>
			aria-label="
			<?php
			esc_html_e( 'Navigation Menu', 'khutar' );
			?>
			">
		<?php
		if ( ! empty( $label ) ) {
		...
		<span class="screen-reader-text"><?php esc_html_e( 'Toggle Navigation', 'khutar' ); ?></span>
	</button>

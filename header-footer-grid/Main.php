...
class Main {
	...
	public function init() {
		add_filter( 'khutar_style_subscribers', array( $this, 'inline_styles' ) );
	...
	private function should_enqueue_assets() {
		...
		if ( is_singular() ) {
			$id     = get_the_ID();
			$header = get_post_meta( $id, 'khutar_meta_disable_header', true );
			$footer = get_post_meta( $id, 'khutar_meta_disable_footer', true );

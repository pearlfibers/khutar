...
use khutar\Views\Partials\Post_Meta;
use khutar\Views\Post_Layout;
...
class Magic_Tags {
	...
	public function meta_author() {
		return '<span class="nv-dynamic-author-meta">' . Post_Meta::khutar_get_author_meta() . '</span>';
	}
	...
	public function meta_date() {
		ob_start();
		do_action( 'khutar_post_meta_single', array( 'date' ), false );
		$meta = ob_get_contents();
		ob_end_clean();
	...
	public function meta_time_to_read() {
		return apply_filters( 'khutar_do_read_time', '' );
	}
	...
	private function setup_config() {
		$this->options = [
			[
				'label'    => __( 'Single', 'khutar' ),
				'controls' => [
					'current_single_title'   => [
						'label' => __( 'Current Single Title', 'khutar' ),
						'type'  => 'string',
					],
					'current_single_excerpt' => [
						'label' => __( 'Current Single Excerpt', 'khutar' ),
						'type'  => 'string',
					],
					'current_single_url'     => [
						'label' => __( 'Current Single URL', 'khutar' ),
						'type'  => 'url',
					],
					'current_post_meta'      => [
						'label' => __( 'Current Post Meta', 'khutar' ),
						'type'  => 'string',
					],
					'meta_author'            => [
						'label' => __( 'Author meta', 'khutar' ),
						'type'  => 'string',
					],
					'meta_date'              => [
						'label' => __( 'Date meta', 'khutar' ),
						'type'  => 'string',
					],
					'meta_category'          => [
						'label' => __( 'Category meta', 'khutar' ),
						'type'  => 'string',
					],
					'meta_comments'          => [
						'label' => __( 'Comments meta', 'khutar' ),
						'type'  => 'string',
					],
				],
			],
			[
				'label'    => __( 'Archive', 'khutar' ),
				'controls' => [
					'archive_description' => [
						'label' => __( 'Archive Description', 'khutar' ),
						'type'  => 'string',
					],
					'archive_title'       => [
						'label' => __( 'Archive Title', 'khutar' ),
						'type'  => 'string',
					],
					'archive_url'         => [
						'label' => __( 'Archive URL', 'khutar' ),
						'type'  => 'url',
					],
				],
			],
			[
				'label'    => __( 'Author', 'khutar' ),
				'controls' => [
					'author_bio'  => [
						'label' => __( 'Author Bio', 'khutar' ),
						'type'  => 'string',
					],
					'author_name' => [
						'label' => __( 'Author Name', 'khutar' ),
						'type'  => 'string',
					],
					'author_url'  => [
						'label' => __( 'Author URL', 'khutar' ),
						'type'  => 'url',
					],
				],
			],
			[
				'label'    => __( 'Current User', 'khutar' ),
				'controls' => [
					'user_nicename' => [
						'label' => __( 'User Nice Name', 'khutar' ),
						'type'  => 'custom_user',
					],
					'display_name'  => [
						'label' => __( 'Display Name', 'khutar' ),
						'type'  => 'custom_user',
					],
					'user_email'    => [
						'label' => __( 'User Email', 'khutar' ),
						'type'  => 'custom_user',
					],
				],
			],
			[
				'label'    => __( 'Global', 'khutar' ),
				'controls' => [
					'site_title'   => [
						'label' => __( 'Site Title', 'khutar' ),
						'type'  => 'string',
					],
					'site_tagline' => [
						'label' => __( 'Site Tagline', 'khutar' ),
						'type'  => 'string',
					],
					'home_url'     => [
						'label' => __( 'Home URL', 'khutar' ),
						'type'  => 'url',
					],
					'current_year' => [
						'label' => __( 'Current Year', 'khutar' ),
						'type'  => 'string',
					],
				],
			],
			[
				'label'    => __( 'Cart', 'khutar' ),
				'controls' => [
					'cart_total_currency_symbol' => [
						'label' => __( 'Total + Currency Symbol', 'khutar' ),
						'type'  => 'custom_cart',
					],
					'cart_total'                 => [
						'label' => __( 'Total', 'khutar' ),
						'type'  => 'custom_cart',
					],
					'currency_name'              => [
						'label' => __( 'Currency Name', 'khutar' ),
						'type'  => 'custom_cart',
					],
					'currency_symbol'            => [
						'label' => __( 'Currency Symbol', 'khutar' ),
						'type'  => 'custom_cart',
					],
				],
			],
		...
		if ( class_exists( 'WooCommerce', false ) ) {
			$this->options[] = [
				'label'    => __( 'WooCommerce', 'khutar' ),
				'controls' => [
					'product_price' => [
						'label' => __( 'Product Price', 'khutar' ),
						'type'  => 'string',
					],
					'product_title' => [
						'label' => __( 'Product Title', 'khutar' ),
						'type'  => 'string',
					],
					'cart_link'     => [
						'label' => __( 'Cart URL', 'khutar' ),
						'type'  => 'url',
					],
					'checkout_link' => [
						'label' => __( 'Checkout URL', 'khutar' ),
						'type'  => 'url',
					],
				],
			];
		...
		$this->options = apply_filters( 'khutar_magic_tags_config', $this->options );

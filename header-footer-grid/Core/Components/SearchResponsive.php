...
class SearchResponsive extends Abstract_Component {
	...
	public function init() {
		$this->set_property( 'label', __( 'Search Icon', 'khutar' ) );
	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'options'            => [
					'choices' => [
						'canvas'   => __( 'Canvas', 'khutar' ),
						'minimal'  => __( 'Minimal', 'khutar' ),
						'floating' => __( 'Float Above Header', 'khutar' ),
					],
				],
				'section'            => $this->section,
				'conditional_header' => true,
	...
	public function add_style( array $css_array = array() ) {
		if ( is_admin_bar_showing() ) {
			wp_add_inline_style( 'khutar-style', 'body.admin-bar .floating .nv-nav-search {margin-top: 32px;}' );
		}
	...
	public function change_placeholder( $form ) {
		$form        = '';
		$placeholder = get_theme_mod( $this->id . '_placeholder', __( 'Search for...', 'khutar' ) );

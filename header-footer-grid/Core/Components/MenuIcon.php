...
class MenuIcon extends Abstract_Component {
	...
	public function init() {
		$this->set_property( 'label', __( 'Menu Icon', 'khutar' ) );
	...
	public function add_settings() {
					...
					'options' => array(
						'quickLinks' => array(
							'toggle_sidebar' => array(
								'label' => esc_html__( 'Show Mobile Menu', 'khutar' ),
								'icon'  => 'dashicons-nametag',
							),
							'hfg_header_layout_sidebar_layout' => array(
								'label' => esc_html__( 'Mobile Menu Options', 'khutar' ),
		...
		SettingsManager::get_instance()->add(
			[
				...
				'label'                 => __( 'Appearance', 'khutar' ),
				'type'                  => '\khutar\Customizer\Controls\React\Button_Appearance',
				'section'               => $this->section,
				'options'               => [
					'no_hover' => true,
				],

...
class Logo extends Abstract_Component {
	...
	public function init() {
		$this->set_property( 'label', __( 'Logo & Site Identity', 'khutar' ) );
		$this->set_property( 'description', __( 'Display your company logo here or simply use words to describe your business.', 'khutar' ) );
	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => 1,
				'label'              => __( 'Show Site Tagline', 'khutar' ),
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => 1,
				'label'              => __( 'Show Site Title', 'khutar' ),
				'type'               => 'khutar_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'label'             => __( 'Logo max width', 'khutar' ),
		...
		SettingsManager::get_instance()->add(
			[
				...
				'sanitize_callback'  => 'absint',
				'default'            => false,
				'label'              => __( 'Disable Homepage Link', 'khutar' ),
				'type'               => 'khutar_toggle_control',
				'section'            => $this->section,
				'conditional_header' => true,
			]
	...
	public function add_style( array $css_array = array() ) {
		...
		$css_array[] = [
			...
			Dynamic_Selector::KEY_RULES    => [
				\khutar\Core\Settings\Config::CSS_PROP_COLOR => $this->get_id() . '_' . self::COLOR_ID,
			],
		];

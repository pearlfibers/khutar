...
class CustomHtml extends Abstract_Component {
	...
	public function init() {
		$this->set_property( 'label', __( 'HTML', 'khutar' ) );
	...
	public function add_settings() {
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => get_theme_mod( 'khutar_top_bar_content', '' ),
				' '                  => '',
				'label'              => __( 'HTML', 'khutar' ),
				'description'        => __( 'Arbitrary HTML code. It supports also shortcodes.', 'khutar' ),
				'type'               => 'textarea',

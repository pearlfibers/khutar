...
use khutar\Core\Styles\Css_Prop;
use khutar\Core\Styles\Dynamic_Selector;
use khutar_Pro\Modules\Blog_Pro\Dynamic_Style;
	...
	public function define_row_settings( $row_id ) {
		...
		if ( $row_id !== 'sidebar' ) {
			SettingsManager::get_instance()->add(
				[
					...
					'label'              => __( 'Layout', 'khutar' ),
					'type'               => 'select',
					'section'            => $row_setting_id,
					'options'            => [
						'choices' => [
							'layout-full-contained' => __( 'Full Width', 'khutar' ) . ' - ' . __( 'Contained', 'khutar' ),
							'layout-fullwidth'      => __( 'Full Width', 'khutar' ),
							'layout-contained'      => __( 'Contained', 'khutar' ),
						],
					],
		...
		SettingsManager::get_instance()->add(
			[
				...
				'tab'                   => SettingsManager::TAB_STYLE,
				'section'               => $row_setting_id,
				'label'                 => __( 'Row Background', 'khutar' ),
				'type'                  => 'khutar_background_control',
				...
				'transport'             => 'postMessage',
				'sanitize_callback'     => 'khutar_sanitize_background',
				'conditional_header'    => $this->get_id() === 'header',
			]
		);
	...
	private function add_sidebar_controls( $row_setting_id ) {
		SettingsManager::get_instance()->add(
			[
				...
				'group'              => $row_setting_id,
				'tab'                => SettingsManager::TAB_LAYOUT,
				'label'              => __( 'Open Behaviour', 'khutar' ),
				'type'               => 'select',
				'section'            => $row_setting_id,
				'options'            => [
					'choices' => [
						'slide_left'  => __( 'Slide from Left', 'khutar' ),
						'slide_right' => __( 'Slide from Right', 'khutar' ),
						'pull_left'   => __( 'Pull from Left', 'khutar' ),
						'pull_right'  => __( 'Pull from Right', 'khutar' ),
						'full_canvas' => __( 'Full Canvas', 'khutar' ),
						'dropdown'    => __( 'Slide Down', 'khutar' ),
					],
				],
				'conditional_header' => $this->get_id() === 'header',
				'transport'          => 'refresh',
